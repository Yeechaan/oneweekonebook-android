...
public class AdapterRead extends RecyclerView.Adapter<AdapterRead.ViewHolder> {
    Context context;
    ArrayList<ItemRead> items = new ArrayList<ItemRead>();
    ...
    public AdapterRead(Context context) {
    ...
    public AdapterRead.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View itemView = inflater.inflate(R.layout.item_read, parent, false);
    ...
    public void onBindViewHolder(@NonNull AdapterRead.ViewHolder holder, int position) {
        ItemRead item = items.get(position);
        holder.setItem(item);
    ...
    //하나 추가
    public void addItem(ItemRead item){
        items.add(item);
    }
    //하나 제거
    ...
    static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public void setItem(ItemRead item){
