...
public class WantAddActivity extends AppCompatActivity {
    ...
    public void insertData(){
        ...
        if(database != null){
            String sqlInsert = "insert into want(title, writer, pub, pic_cover) values(?, ?, ?, ?)";
            ...
            Toast.makeText(getApplicationContext(), "보고싶은 책 목록에 추가!", Toast.LENGTH_SHORT).show();
            finish();
        }
    }
