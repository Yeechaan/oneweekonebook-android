...
public class AdapterWant extends RecyclerView.Adapter<AdapterWant.ViewHolder> {
    Context context;
    ...
    public AdapterWant(Context context) {
        this.context = context;
    }

    @NonNull
    @Override
    public AdapterWant.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View itemView = inflater.inflate(R.layout.item_want, parent, false);

        return new ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterWant.ViewHolder holder, int position) {
        ItemWant item = items.get(position);
        holder.setItem(item);
    ...
    //하나 추가
    public void addItem(ItemWant item){
        items.add(item);
    }
    //하나 제거
    ...
    static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public void setItem(ItemWant item){
